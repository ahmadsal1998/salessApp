...
import { MapPin, Phone, User, Building2, Calendar, Navigation, Edit2, ArrowLeft, Plus, Globe, Link as LinkIcon, CalendarX, Star, Clock, AlertCircle } from 'lucide-react'
    ...
    <div className="space-y-4 max-w-4xl">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-0.5">{customer.category}</p>
          </div>
        ...
        {customer.latitude && customer.longitude && (
          <div className="mt-4 p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <span className="text-xs text-gray-500">{visits.length} {t('visits.title').toLowerCase()}</span>
        </div>
        {visits.length === 0 ? (
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-700">
            {visits.map((v) => (
              <div key={v.id} className="p-4 flex items-start justify-between gap-4 hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors">
                ...
                <p className="text-xs text-gray-500 shrink-0">{(v.employee as { full_name: string })?.full_name}</p>
              </div>
            ))}
          </div>
        )}
